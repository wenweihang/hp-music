...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">歌单${param.sl_name}</li>
    </ol>
</section>
<!-- 内容头部 /-->
            ...
            <div class="table-box" style="height: 530px">
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default" id="addSongToSL" title="添加歌曲"><i
...
<script>
    $(function () {
        //默认初始化数据
        var currPage = 1
        var sg_songListName = '${param.sl_name}'  //歌单列表传过来的,sl_name等于song_list表中的sg_songList
        ...
        $.ajax({
            ...
            success: function (data) {
                songs = data.page.lists //获取歌单中的歌曲集合
        ...
        $("#addSongToSL").click(function () {
            layer.open({
                ...
                time: 0, //2秒后自动关闭
                anim: 0,
                content: ['include/admAddSongToSL.jsp?sg_songList=' + sg_songListName, 'no'], //iframe的url，no代表不显示滚动条
            });
        })
        //刷新
        $("#refresh").click(function () {
            $(".content-wrapper").load("include/admSongList.jsp"
                , {
                    sl_name: sg_songListName,
                }
                ,
                function () {
