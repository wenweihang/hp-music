...
<table class="table table-borderless table-hover">
    ...
    <c:forEach items="${songs}" var="song" varStatus="i">
        <tr class="tr-song song${i.index}">
            ...
            <td class="ctb-name">
                <span class="sl-name"><a href="#">${song.sg_name}</a></span>
                <span id="lossless">无损</span>
            </td>
            <td class="ctb-author">${song.sg_author}</td>
            <td class="ctb-icon">
            ...
            <td class="ctb-time">${song.sg_time}</td>
            <td class="sg_songList" style="display: none;">${song.sg_songList}</td>
            <td class="id" style="display: none;">${song.sg_id}</td>
            <td class="imgAddress" style="display: none;">${song.sg_imgAddress}</td>
            <td class="musAddress" style="display: none;">${song.sg_address}</td>
            <td class="collect" style="display: none;">${song.collect}</td>
            <td class="language" style="display: none;">${song.sg_language}</td>
            <td class="szj_title" style="display: none;">${song.szj_title}</td>
            <td class="szj_detail" style="display: none;">${song.szj_detail}</td>
        </tr>
    </c:forEach>
    </tbody>
</table>
